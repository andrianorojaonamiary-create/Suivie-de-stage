...
export class InternshipsService {
  ...
  async remove(id: string, actor: AuthenticatedUser) {
    if (actor.role === Role.ETUDIANT) {
      ...
      if (internship.statut !== InternshipStatus.EN_ATTENTE) {
        throw new ForbiddenException(
          'Un stage déjà validé ne peut plus être supprimé.',
        );
      }
    ...
    return {
      ...
      student: internship.student
        ? {
            ...
            promotion: internship.student.promotion,
            telephone: internship.student.telephone,
            adresse: internship.student.adresse,
            statutAcademique: internship.student.statutAcademique,
            situationProfessionnelle: internship.student.situationProfessionnelle,
