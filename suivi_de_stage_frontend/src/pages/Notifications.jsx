...
function Notifications() {
  ...
  const notifications = useMemo(() => {
    ...
    if (role === 'ROLE_ADMIN') {
      return [
        { id: 1, type: 'Système', text: 'Nouvel utilisateur inscrit : Miora Rakoto', time: 'Il y a 12 min', read: false, icon: <FaUserPlus />, color: '#6BA9E6', bg: '#E1ECFE' },
        ...
        { id: 5, type: 'Entreprise', text: 'Nouvelle entreprise partenaire : Orange Madagascar', time: 'Hier à 14:30', read: true, icon: <FaBuilding />, color: '#162449', bg: '#EEF5FC' },
      ];
    }
    ...
    if (role === 'ROLE_ETUDIANT') {
      return [
        ...
        { id: 5, type: 'Échéance', text: 'Prochaine échéance : 15 Mai 2024', time: 'Il y a 3 h', read: true, icon: <FaCalendarAlt />, color: '#6BA9E6', bg: '#E1ECFE' },
    ...
    if (role === 'ROLE_ENSEIGNANT') {
      return [
        { id: 1, type: 'Stage', text: 'Nouveau stage en attente de validation (Miora Rakoto)', time: 'Il y a 12 min', read: false, icon: <FaFileAlt />, color: '#6BA9E6', bg: '#E1ECFE' },
        ...
        { id: 4, type: 'Info', text: '12 étudiants suivis ce semestre', time: 'Il y a 3 h', read: true, icon: <FaUsers />, color: '#162449', bg: '#EEF5FC' },
    ...
    if (role === 'ROLE_ENCADREUR') {
      return [
        { id: 1, type: 'Stage', text: 'Nouveau stage à suivre chez TechMada SARL', time: 'Il y a 12 min', read: false, icon: <FaBuilding />, color: '#6BA9E6', bg: '#E1ECFE' },
    ...
    return [
      { id: 1, type: 'Bienvenue', text: 'Bienvenue sur la plateforme de suivi des stages', time: 'Maintenant', read: false, icon: <FaBell />, color: '#6BA9E6', bg: '#E1ECFE' },
    ];
  }, [user?.role]);
